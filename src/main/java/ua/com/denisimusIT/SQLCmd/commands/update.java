...
//•Формат: ua.com.denisimusIT.SQLCmd.commands.update | tableName | column1 | value1 | column2 | value2
...
//•Формат вывода: табличный, как при ua.com.denisimusIT.SQLCmd.commands.find со старыми значениями обновленных записей.
    }
